...
const footerConfigSquema = new Schema({
  colors: {
    primaryColorFooter: {
      ...
      required: [
        true,
        "required: primaryColorFooter-colors-footerConfigSquema : mongoose squema",
      ],
      default: "#000000",
    },
  },
  social: {
    instagram: {
      ...
      required: [
        true,
        "required: instagram-social-footerConfigSquema: mongoose squema",
      ],
      default: "undefined",
    },
    facebook: {
      ...
      required: [
        true,
        "required: facebook-social-footerConfigSquema: mongoose squema",
      ],
      default: "undefined",
    },
    gmail: {
      ...
      required: [
        true,
        "required: gmail-social-footerConfigSquema: mongoose squema",
      ],
      default: "undefined",
    },
    whatsapp: {
      ...
      required: [
        true,
        "required: whatsapp-social-footerConfigSquema: mongoose squema",
      ],
      default: "undefined",
    },
    storeAddress: {
      ...
      required: [
        true,
        "required: storeAddress-social-footerConfigSquema: mongoose squema",
      ],
      default: "undefined",
    },
  },
...
const logoConfigSchema = new Schema({
  logoUrl: {
    type: String,
    required: [true, "required: logoConfigSchema logoConfig: mongoose squema"],
  },
});
...
const storeConfigurationSchema = new Schema({
  ...
  logoConfig: {
    type: logoConfigSchema,
    required: [true, "required: logoConfig : mongoose squema"],
    _id: false,
  },
});
