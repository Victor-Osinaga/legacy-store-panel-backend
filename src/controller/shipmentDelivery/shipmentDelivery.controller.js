...
const createShipmentDelivery = async (req, res) => {
  ...
  try {
    const shipmentDeliveryService = await shipmentDeliveryServiceFactory(
      dbname
    );
    console.log("body shipmentDelivery create", req.body);

    const createdShipmentDelivery =
      await shipmentDeliveryService.createShipmentDelivery(req.body);
...
const getShipmentsDelivery = async (req, res) => {
  ...
  try {
    ...
    const shipmentsDelivery =
      await shipmentDeliveryService.getShipmentsDelivery();
...
const deleteShipmentDeliveryById = async (req, res) => {
  ...
  try {
    ...
    const deletedShipmentDelivery =
      await shipmentDeliveryService.deleteShipmentDeliveryById(
        req.params.shipmentDeliveryId
      );
...
const updateShipmentDeliveryById = async (req, res) => {
  ...
  try {
    ...
    const updatedShipmentDelivery =
      await shipmentDeliveryService.updateShipmentDeliveryById(
        req.params.shipmentDeliveryId,
        req.body
      );
...
const getShipmentDeliveryById = async (req, res) => {
  console.log(
    "body desde getShipmentDeliveryById",
    req.params.shipmentDeliveryId
  );
  ...
  try {
    ...
    const shipmentDelivery =
      await shipmentDeliveryService.getShipmentDeliveryById(
        req.params.shipmentDeliveryId
      );
    res.status(200).json({ status: "ok", data: shipmentDelivery });
  } catch (error) {
    console.log("error desde controller : getShipmentDeliveryById", error);
    res.status(500).json({ status: "failed", data: error.msg });
  }
};
...
const getShipmentsDeliveryStore = async (req, res) => {
  ...
  try {
    ...
    const shipmentsDelivery =
      await shipmentDeliveryService.getShipmentsDeliveryStore();
    res.status(200).json({ status: "ok", data: shipmentsDelivery });
  } catch (error) {
